...
comparisons={'overall_classSleep';'overall_classSed';'overall_classLight';'overall_100mg'};

colorx = {'[0.1 0.1 0.6]';'white'; 'cyan'; 'white';'blue'};
linecolorx = {'[0.1 0.1 0.6]';'[0.5 0.8 0.0]'; 'cyan'; '[0.8 0.2 0.2]';'blue'};
markersx = {'*';'o';'x';'s';'^'};
markersizex = 11;
...
for i=1:4
	...
	% all vs basex
	ix = find(strcmp(allx.base,'allS')==1 & strcmp(allx.comp,basex)==1  & strcmp(allx.test, 'cox-hr')==1 & strcmp(allx.adjusted,'TRUE')==1);
	...
	posx = i;
	hold on; h1=plot([posx,posx], [1/allx.lower(ix), 1/allx.upper(ix)], '-', 'color', colorx{5}, 'linewidth', 3);
        hold on; h1=plot(posx, 1/allx.beta(ix), markersx{5}, 'MarkerFaceColor', 'white', 'MarkerEdgeColor', colorx{5}, 'MarkerSize', markersizex);
	hx(1) = h1;
...
labelsx = {'Sleep';'Sedentary';'Light';'MVPA'};
set(gca,'XTickLabel', labelsx);

set(gca,'XTick', [1.4:1:4.4]);
